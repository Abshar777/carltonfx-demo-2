let ENABLE_PAGE_PRELOADER = false,
  DEFAULT_DARK_MODE = !1,
  USE_LOCAL_STORAGE = !0,
...
document.addEventListener("DOMContentLoaded", function () {
  const e = document.getElementById("uc-gdpr-notification"),
    t = document.getElementById("uc-accept-gdpr"),
    a = document.getElementById("uc-close-gdpr-notification"),
    n = localStorage.getItem("gdprAccepted");
  e &&
    (n ||
      setTimeout(function () {
