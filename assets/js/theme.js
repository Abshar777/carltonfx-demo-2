...
(function ($) {
  ...
  $(".tt-text-reveal-teri").each(function () {
    $(this).wrapInner("<span/>");
  });

  // Convert the elements into an array for GSAP
  let ttTextRevealElementsTeri = gsap.utils.toArray(".tt-text-reveal-teri");
  ...
  $(".tt-text-reveal-sub").each(function () {
    $(this).wrapInner("<span/>");
  });

  // Convert the elements into an array for GSAP
  let ttTextRevealElementssub = gsap.utils.toArray(".tt-text-reveal-sub");
