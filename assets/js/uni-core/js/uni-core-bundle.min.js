/*! UniCore 3.19.1 | https://www.unistudio.co | (c) 2024 - 2024 UniStudio | MIT License */ (function (
  te,
  $e
) {
  ...
  const er = /\B([A-Z])/g,
    Mt = rt((t) => t.replace(er, "-$1").toLowerCase()),
    ir = /-(\w)/g,
    ye = rt((t) =>
      (t.charAt(0).toLowerCase() + t.slice(1)).replace(ir, (e, i) =>
        i.toUpperCase()
      )
    ),
  ...
  const ji = { ratio: Wi, contain: Ls, cover: sr };
  ...
  const lr = /.*?[^\\](?![^(]*\))(?:,|$)/g,
    hr = rt((t) => t.match(lr).map((e) => e.replace(/,$/, "").trim()));
  function cr(t) {
    const e = [];
    for (; t.parentNode; ) {
      const i = p(t, "id");
        ...
        (o) =>
          new Promise((r, a) => {
            ...
            H(
              ...
              $(o, e, De + (n ? "leave" : "enter")),
              dt(e, De) &&
                (s && $(o, `uc-transform-origin-${s}`),
                n && $(o, `${De}reverse`));
          })
      )
    );
  }
  const wr = new RegExp(`${De}(enter|leave)`),
    At = {
      in: Ys,
      out(t, e, i, s) {
        return Ys(t, e, i, s, !0);
  ...
  function es(t, e) {
    return T(
      T(t).map((i) => (i.hasChildNodes() ? di(It(i.childNodes), e) : L(i, e)))
    );
  }
  function re(t) {
    T(t)
  ...
  function w(t) {
    const e = Se(t)
      ...
      : { height: st(t), width: fi(t), top: 0, left: 0 };
    return {
      height: e.height,
      width: e.width,
      top: e.top,
  ...
  const kr = /-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g,
    Sr = rt((t) => t.toString().replace(/\s/g, "").match(kr) || []),
    Ir = /(?:v[hw]|%)$/,
    Cr = rt((t) => (t.match(Ir) || [])[0]);
  function Tr(t, e) {
    return (t * S(e)) / 100;
  }
  let Be, ae;
  function Er() {
    return (
      ...
      (ae ||
        ((ae = k("<div>")),
        c(ae, { height: "100vh", position: "fixed" }),
        b(window, "resize", () => (Be = null))),
      L(document.body, ae),
      (Be = ae.clientHeight),
      at(ae),
      Be)
  ...
  const le = typeof window < "u",
    V = le && document.dir === "rtl",
    he = le && "ontouchstart" in window,
    ce = le && window.PointerEvent,
    ft = ce ? "pointerdown" : he ? "touchstart" : "mousedown",
    gi = ce ? "pointermove" : he ? "touchmove" : "mousemove",
    Ot = ce ? "pointerup" : he ? "touchend" : "mouseup",
    ue = ce ? "pointerenter" : he ? "" : "mouseenter",
    Ne = ce ? "pointerleave" : he ? "" : "mouseleave",
    mi = ce ? "pointercancel" : "touchcancel",
    K = {
      reads: [],
      writes: [],
      read(t) {
  ...
  function de(t, e, i = { box: "border-box" }) {
  ...
  function nn(t) {
    wi(t) && rs(t, { func: "playVideo", method: "play" }), vi(t) && t.play();
  }
  function on(t) {
    wi(t) && rs(t, { func: "pauseVideo", method: "pause" }), vi(t) && t.pause();
  }
  function rn(t) {
    wi(t) && rs(t, { func: "mute", method: "setVolume", value: 0 }),
      vi(t) && (t.muted = !0);
  }
  function an(t) {
    return vi(t) || wi(t);
    ...
    function s(r, a, l, h) {
      return new Promise((u) => {
        ...
        (function Qe() {
          ...
          (r.scrollTop = Math[a + pt > 0 ? "max" : "min"](
            r.scrollTop,
            d + (a + pt) * Mi
          )),
            Mi === 1 && (M === pt || !wt--)
              ? u()
              : ((M = pt), requestAnimationFrame(Qe));
        })();
      });
    }
    function n(r) {
  ...
  function ls(t) {
    ...
    return t.ownerDocument.elementsFromPoint(e + i / 2, s).find(
      (n) =>
        !n.contains(t) &&
        !y(n, "uc-togglable-leave") &&
        ((hs(n, "fixed") &&
          dn(
            _e(t)
              .reverse()
              .find((o) => !o.contains(n) && !hs(o, "static"))
          ) < dn(n)) ||
          (hs(n, "sticky") && P(n).contains(t)))
    );
  }
  function dn(t) {
    return S(c(t, "zIndex"));
  ...
  (Y.events =
    ...
    (Y.update = function (t, e) {
      return Fs(ds(t, it(e) ? { read: e } : e), "order");
    }),
  ...
  function ze(t, e, i) {
    ...
    if (
      (it(e) && (e = e.options),
      e.extends && (t = ze(t, e.extends, i)),
      e.mixins)
    )
      for (const o of e.mixins) t = ze(t, o, i);
  ...
  function Vr(t) {
    return Q(t)
      ? t
      : N(t)
      ? t.split(Ur).map((e) => (vt(e) ? $t(e) : zi(e.trim())))
      : [t];
  }
  function Yr(t) {
  ...
  function Jr(t, e) {
    for (const { read: i, write: s, events: n = [] } of t._updates) {
      ...
      let o;
      i && ((o = i.call(t, t._data, e)), o && xt(o) && mt(t._data, o)),
        s &&
          o !== !1 &&
          K.write(() => {
  ...
  function Le(t = {}) {
    return He({
      handler: function (e, i) {
        ...
        for (const o of T(it(s) ? s(this) : s))
          z('[loading="lazy"]', o)
            .slice(0, n - 1)
  ...
  function We(t) {
    return je(
      (e, i) => ({ disconnect: b(Zr(e), "scroll", i, { passive: !0 }) }),
      t,
      "scroll"
    );
  }
  ...
  const ws = "uc-transition-leave",
    bs = "uc-transition-enter";
  function Sn(t, e, i, s = 0) {
    const n = $i(e, !0),
      o = { opacity: 1 },
      r = { opacity: 0 },
      a = (u) => () => n === $i(e) ? u() : Promise.reject(),
      l = a(async () => {
        $(e, ws),
          await Promise.all(
            Cn(e).map(
              (u, d) =>
                new Promise((f) =>
                  setTimeout(() => D.start(u, r, i / 2, "ease").then(f), d * s)
                )
            )
          ),
          O(e, ws);
      ...
      h = a(async () => {
        const u = st(e);
        $(e, bs), t(), c(B(e), { opacity: 0 }), await Qr();
        const d = B(e),
          f = st(e);
        ...
        u !== f &&
          x.push(D.start(e, { height: f }, i / 2 + v.length * s, "ease")),
  ...
  function $i(t, e) {
    return (
      e && (t.dataset.transition = 1 + $i(t)), $t(t.dataset.transition) || 0
    );
  }
  function In(t) {
    return Promise.all(
      B(t)
        .filter(D.inProgress)
        .map(
          (e) => new Promise((i) => H(e, "transitionend transitioncanceled", i))
        )
    );
  }
  function Cn(t) {
  ...
  async function ea(t, e, i) {
    ...
    await Promise.all(s.concat(e).map(D.cancel)),
      t(),
    ...
    s.forEach((f, v) => h[v] && c(f, h[v])),
      ...
      await Pn();
    const d = s
      .map((f, v) => P(f) === e && D.start(f, l[v], i, "ease"))
      .concat(D.start(e, a, i, "ease"));
    try {
      await Promise.all(d),
        s.forEach((f, v) => {
          p(f, u[v]),
    ...
    methods: {
      ...
      getState() {
        return this.toggles
          ...
          .reduce((t, e) => On(e, this.attrItem, t), {
            filter: { "": "" },
            sort: [],
          });
      },
      ...
      (s || X(o)) &&
        (n
          ? s
            ...
            : (delete i.filter[n],
              (ei(i.filter) || "" in i.filter) && (i.filter = { "": s || "" }))
          : (i.filter = { "": s || "" })),
      X(o) || (i.sort = [o, r]),
      i
    );
  ...
  function ha(t, e, i) {
    return [...t].sort(
      (s, n) =>
        G(s, e).localeCompare(G(n, e), void 0, { numeric: !0 }) *
        (i === "asc" || -1)
    );
  }
  function ca(t) {
  ...
  function Dn(t) {
    const e = b(t, "touchstart", (s) => {
      if (s.targetTouches.length !== 1 || E(s.target, 'input[type="range"'))
        return;
      let n = _t(s).y;
      const o = b(
        t,
  ...
  async function da(
    ...
    s = (n * Qt + s) * (e ? 1 - Ko : Ko);
    const Zo = { [x]: e ? Qt : 0 };
    f && (c(t, C, Qt - wt + xe), (Zo[C] = e ? xe : Qt + xe)),
      !f ^ (l === "reveal") &&
        (c(Bi, C, -Qt + wt), D.start(Bi, { [C]: e ? 0 : -Qt }, s, o));
    try {
    ...
    events: [
      ...
      },
      {
        ...
        handler() {
          ...
          const t = [
            this.overlay && ga(this),
            this.overlay && Dn(this.$el),
            this.bgClose && ma(this),
            this.escClose && va(this),
          ];
    ...
    return {
      ...
      show(u, d = 0, f) {
        ...
        return (
          ...
          this.translate(d),
          yi(e, "itemin", { percent: d, duration: u, timing: v, dir: i }),
          yi(t, "itemout", { percent: 1 - d, duration: u, timing: v, dir: i }),
          new Promise((x) => {
            h || (h = x),
              Promise.all([
                D.start(e, l[1], u, v),
      ...
      translate(u) {
        ...
        c(e, d[1]),
          c(t, d[0]),
          yi(e, "itemtranslatein", { percent: u, dir: i }),
          yi(t, "itemtranslateout", { percent: 1 - u, dir: i });
      },
      percent() {
        return o(t || e, e, i);
      },
    ...
    methods: {
      ...
      move(t) {
        ...
        if (
          ...
          return;
        this.dragging || b(this.list, "click", zn, Ue),
        ...
        setTimeout(() => Pt(this.list, "click", zn, Ue)),
  ...
  function Sa(t, e) {
    for (const { name: i, handler: s, immediate: n = !0 } of t._watches)
      ((t._initial && n) || (gt(e, i) && !ii(e[i], t[i]))) &&
        s.call(t, t[i], e[i]);
    t._initial = !1;
  }
  function Ia(t) {
  ...
  function Ca(t) {
    t._hasComputed &&
      (Xr(t, { read: () => Sa(t, Wn(t)), events: ["resize", "computed"] }),
      Ea(),
      Ve.add(t));
  }
  function Ta(t) {
  ...
  function qn(t, e) {
    ...
    it(s) &&
      Q(t[l]) &&
      u.unobserve &&
      Hn(t, { handler: Da(u), immediate: !1 }, l),
      Rn(t, u);
  }
  function Da(t) {
    return (e, i) => {
  ...
  function Vn(t, e = {}) {
    (e.data = La(e, t.constructor.options)),
      (t.$options = ze(t.constructor.options, e, t)),
      (t.$props = {}),
      (t._uid = za++),
      Fa(t),
      Ha(t),
  ...
  function La({ data: t = {} }, { args: e = [], props: i = {} }) {
    Q(t) &&
      (t = t
        .slice(0, e.length)
        .reduce((s, n, o) => (xt(n) ? mt(s, n) : (s[e[o]] = n), s), {}));
        ...
        navItems(t) {
          for (const e of t) {
            ...
            if (vt(i)) {
              const r = $t(i),
                a = this.slides[r];
              a && (a.id || (a.id = Gt(this, a)), (o = a.id)),
                (n = this.t("slideX", S(i) + 1)),
                p(s, "role", "tab");
            } else
              this.list &&
                (this.list.id || (this.list.id = Gt(this, this.list)),
                (o = this.list.id)),
                (n = this.t(i));
      ...
      events: [
        {
          ...
          handler(t) {
            t.target.closest("a,button") &&
              ...
              (t.preventDefault(), this.show(G(t.current, this.attrItem)));
          },
        },
  ...
  var Zn = {
    ...
    to = {
      ...
      events: [
        { name: `${gi} ${ft} keydown`, handler: "showControls" },
        {
          name: "click",
          self: !0,
          delegate() {
  ...
  function Ja(t, e) {
    t.lightboxPanel || t.component("lightboxPanel", to),
      mt(e.props, t.component("lightboxPanel").options.props);
  }
  function eo(t) {
    const e = {};
    for (const i of ["href", "caption", "type", "poster", "alt", "attrs"])
      e[i === "href" ? "source" : i] = G(t, i);
  ...
  var Ka = {
    ...
    methods: {
      async close(t) {
        ...
        this.timer && clearTimeout(this.timer),
          t || (await D.start(this.$el, this.startProps)),
          e(this.$el);
      },
    },
  };
  ...
  var ve = {
    ...
    connected() {
      const t = io(this.media, this.$el),
        e = io(this.mediaMax, this.$el, "max");
  ...
  function io(t, e, i = "min") {
    if (N(t)) {
      if (dt(t, "@")) t = S(c(e, `--uc-breakpoint-${t.substr(1)}`));
      ...
      (s, n) => {
        const [o, r, a] = ho(i, n),
          l = o
            .map(
              (h, u) => (
                (h += a * (r[u] - h)), u === 3 ? S(h) : parseInt(h, 10)
              )
            )
            .join(",");
        s[t] = `rgba(${l})`;
  ...
  function el(t, e, i) {
    ...
    const s = Ei(i),
      n = so(e);
    return (
      (i = we(i.reverse(), (o) => ((o = S(o)), s === "%" ? (o * n) / 100 : o))),
      i.some(([o]) => o)
  ...
  var ol = {
    ...
    observe: [
      ...
      ct({ target: ({ $el: t, target: e }) => [t, e, Dt(e, !0)] }),
    ],
    update: {
      read({ percent: t }, e) {
        ...
        const i = t;
        return (
          (t = uo(bi(this.target, this.start, this.end), this.easing)),
    ...
    update: {
      write() {
        ...
        const t = this.parallaxTarget,
          ...
          s = uo(bi(t, e, i), this.parallaxEasing),
  ...
  function al(t, e, i, { center: s, easing: n, list: o }) {
    const r = t ? Ke(t, o, s) : Ke(e, o, s) + w(e).width * i,
      a = e ? Ke(e, o, s) : r + w(t).width * i * (V ? -1 : 1);
    let l;
    return {
      dir: i,
      show(h, u = 0, d) {
        ...
        return (
          ...
          new Promise((v) => {
            l || (l = v),
              D.start(o, { transform: W(-a * (V ? -1 : 1), "px") }, h, f).then(
                l,
                A
              );
          })
      ...
      translate(h) {
        ...
        c(
          o,
          "transform",
          W(tt(-a + (u - u * h), -be(o), w(o).width) * (V ? -1 : 1), "px")
        );
  ...
  var hl = {
    ...
    events: {
      beforeitemshow(t) {
        ...
        (this.duration = Kn(s / this.velocity) * (w(this.slides[i]).width / s)),
          this.reorder();
      },
      itemshow() {
        ~this.prevIndex &&
    ...
    events: [
      {
        ...
        handler({
          ...
          K.read(() => {
            if (!this.matchMedia) return;
            const o = this.getCss($o(t, n, e)),
              r = this.getCss(xo(t) ? 0.5 : n > 0 ? 1 : 0);
            K.write(() => {
    ...
    pl = {
      ...
      update: {
        write(t) {
          ...
          const l = wl(a, { x: e, y: i });
          if (a.length && (!l || l === o)) return;
          const h = this.getSortable(o),
            u = bl(r.target, l, o, e, i, r === h && t.moved !== l);
          u !== !1 &&
            ((u && o === u) ||
      ...
      methods: {
        init(t) {
          ...
          !n ||
            ...
            b(document, gi, this.move),
            b(document, Ot, this.end),
        ...
        move(t) {
          ...
          if (
            (Pt(document, gi, this.move),
            Pt(document, Ot, this.end),
            !this.drag)
          )
            return;
          ml();
  ...
  function vl(t, e) {
    ...
    return (
      ...
      st(i.firstElementChild, st(e.firstElementChild)),
      i
    );
  }
  function wl(t, e) {
  ...
  function bl(t, e, i, s, n, o) {
    ...
    const a = w(i),
      l = ko([r.top, r.bottom], [a.top, a.bottom]),
      [h, u, d, f] = l
        ? [s, "width", "left", "right"]
        : [n, "height", "top", "bottom"],
      v = a[u] < r[u] ? r[u] - a[u] : 0;
  ...
  var So = {
    ...
    methods: {
      ...
      getPositionOffset(t = this.$el) {
        return (
          U(
            this.offset === !1 ? c(t, "--uc-position-offset") : this.offset,
    ...
    methods: {
      show() {
        ...
        const i = p(this.$el, "title"),
          s = b(this.$el, ["blur", Ne], (o) => !yt(o) && this.hide());
        this.reset = () => {
  ...
  function Il(t) {
    ...
    return ["delay", "title"].reduce((n, o) => ({ [o]: G(e, o), ...n }), {
      ...fe(G(e, i), ["title"]),
      ...s,
    });
  }
  ...
  function Pl(t, e) {
    return new Promise((i, s) => {
      ...
      b(n, "load", () => {
        ...
        n.status === 304
          ? i(n)
          : s(mt(Error(n.statusText), { xhr: n, status: n.status }));
      }),
        b(n, "error", () => s(mt(Error("Network Error"), { xhr: n }))),
        b(n, "timeout", () => s(mt(Error("Network Timeout"), { xhr: n }))),
        n.send(e.data);
    });
  }
  var _l = {
        ...
        write({ hide: t }) {
          t
            ? "reset" in this.animation &&
              typeof this.animation.reset == "function" &&
  ...
  function Co(t) {
    g(document, "uikit:init", t),
      document.body && kt(document.body, To),
  ...
  async function zl(
    ...
    (s = (n * h + s) * (e ? 1 - u : u)),
      c(a, "height", l),
      await D.start(a, { height: e ? h : 0 }, s, o),
      re(i),
      delete t._wrapper,
      e || Ai(i, !0);
  }
    ...
    Wl = {
      ...
      update: {
        read() {
          ...
          const { offsetHeight: r, offsetWidth: a } = Ao(i) || P(i),
            l = e(o, {
              width: a + (a % 2 ? 1 : 0),
              height: r + (r % 2 ? 1 : 0),
            });
      ...
      },
      {
        ...
        handler() {
          ...
          const t = [
            ...
            Vl(this),
            Xl(this),
            this.autoUpdate && Mo(this),
            this.closeOnScroll && Yl(this),
          ];
          H(this.$el, "hide", () => t.forEach((e) => e && e()), { self: !0 }),
            this.bgScroll || H(this.$el, "hidden", Dn(this.$el), { self: !0 });
        },
      },
    ...
    methods: {
      ...
      hide(t = !0, e = !0) {
        ...
        this.clearTimers(),
          ...
          (this.isDelaying = jl(this.$el).some((s) => this.tracker.movesTo(s))),
          t && this.isDelaying
      ...
      position() {
        O(this.$el, "uc-drop-stack"),
          c(this.$el, this._style),
          (this.$el.hidden = !0);
        const t = this.target.map((n) => Rl(this.$el, n)),
        ...
        (this.$el.hidden = !1),
          c(this.$el, "maxWidth", ""),
          this.$el.offsetWidth > s && $(this.$el, "uc-drop-stack"),
  ...
  function Ul(t) {
    const e = () => t.$emit(),
      i = [os(e), de(Ut(t.$el).concat(t.target), e)];
    ...
    events: [
      ...
      },
      {
        ...
        handler(t) {
          ...
          s === _.DOWN &&
            ...
            (t.preventDefault(), (e = k(Ee, n.$el)) == null || e.focus()),
            No(t, this.items, n);
        },
      },
      {
      ...
      },
      {
        ...
        handler() {
          ...
          t &&
            m(t.mode, "hover") &&
            !this.dropdowns.some((e) => E(e, ":hover")) &&
            t.hide();
        },
      },
      {
        ...
        handler({ target: t }) {
          this.isDropbarDrop(t) &&
            (this.dropbar.previousElementSibling !== this.dropbarAnchor &&
              ci(this.dropbarAnchor, this.dropbar),
    ...
    methods: {
      ...
      async transitionTo(t, e) {
        ...
        c(e, "clipPath", `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`),
          st(i, s),
          await Promise.all([
            D.start(i, { height: t }, this.duration),
            D.start(
              e,
      ...
      update: [
        ...
        },
        {
          read({
            ...
            return e && zo(t) ? !1 : { scrolled: e ? bi(this.$el, i, s) : !1 };
          },
  ...
  const Oi = {
    ...
    Th = {
      ...
      beforeConnect() {
        const t =
          y(this.$el, "uc-search-toggle") || y(this.$el, "uc-navbar-toggle");
        if (
          ((this.icon = t
            ? "search-toggle-icon"
            : y(this.$el, "uc-search-icon") && ri(this.$el, ".uc-search-large")
            ? "search-large"
            : ri(this.$el, ".uc-search-navbar")
            ? "search-navbar"
            : this.$props.icon),
    ...
    Ph = { extends: Zt, i18n: { label: "Open menu" } },
    _h = {
      extends: Zt,
      i18n: { label: "Close" },
      beforeConnect() {
    ...
    Ah = { extends: Zt, i18n: { label: "Open" } },
    Oh = { extends: Zt, i18n: { label: "Back to top" } },
    Dh = { extends: Zt, i18n: { label: "Next page" }, data: { role: null } },
    Mh = {
      extends: Zt,
  ...
  var Hh = {
    ...
    methods: {
      load() {
        ...
        const t = Ds(this.$el)
          ? this.$el
          : Wh(this.$el, this.dataSrc, this.sources);
  ...
  var qh = {
    ...
    observe: [
      ...
      }),
      {
        target: ({ target: t }) => t,
        observe: (t, e) => {
          const i = de([...t, document.documentElement], e),
            s = [
      ...
      read() {
        for (const t of this.target)
          ni(
            t,
            "uc-light,uc-dark",
            !this.selActive || E(t, this.selActive) ? Uh(t) : ""
          );
      },
    },
  };
    ...
    Yh = {
      ...
      events: [
        ...
        },
        {
          ...
          self: !0,
          handler() {
            y(this.panel, "uc-margin-auto-vertical")
              ? $(this.$el, "uc-flex")
  ...
  function Xh({ modal: t }) {
    (t.dialog = function (i, s) {
      const n = t(
        `<div class="uc-modal"> <div class="uc-modal-dialog">${i}</div> </div>`,
  ...
  var Jh = {
    ...
    watch: {
      items() {
        const t = y(this.$el, "uc-navbar-justify"),
          e = z(".uc-navbar-nav, .uc-navbar-left, .uc-navbar-right", this.$el);
        for (const i of e) {
          const s = t
            ? z(
    ...
    events: [
      {
        ...
        handler({ target: t }) {
          this.getTransparentMode(t) === "remove" &&
            ...
            (O(this.navbarContainer, Ms), (this._transparent = !0));
        },
      },
      {
        name: "hide",
      ...
      },
      {
        ...
        handler() {
          this.mode === "reveal" &&
            ...
            (di(this.panel, "<div>"), $(P(this.panel), this.clsMode));
      ...
      },
      {
        ...
        handler() {
          this.clsContainerAnimation && tc(),
            this.mode === "reveal" && re(this.panel),
  ...
  var rc = {
      ...
      observe: He({
        ...
        handler(t) {
          ...
          for (const { target: i, isIntersecting: s } of t) {
            e.has(i) ||
              e.set(i, { cls: G(i, "uc-scrollspy-class") || this.cls });
            const n = e.get(i);
    ...
    lc = {
      ...
      connected() {
        (this.start = Uo(this.start || this.top)),
          (this.end = Uo(this.end || this.bottom)),
          (this.placeholder =
            k("+ .uc-sticky-placeholder", this.$el) ||
            k('<div class="uc-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1);
      },
      beforeDisconnect() {
        this.isFixed && (this.hide(), O(this.target, this.clsInactive)),
          Vo(this.$el),
          at(this.placeholder),
      ...
      update: [
        {
          ...
          write({ height: t, width: e, margin: i, offset: s, sticky: n }) {
            if (
              ((this.inactive || n || !this.isFixed) && Vo(this.$el),
              this.inactive)
            )
              return;
  ...
  function Ns(t) {
    $(t, "uc-transition-disable"),
      requestAnimationFrame(() => O(t, "uc-transition-disable"));
  }
  var hc = {
    mixins: [Ho],
    args: "src",
  ...
  var Go = {
      ...
      update() {
        ...
        p(
          this.$el,
          "aria-orientation",
          E(this.$el, this.selVertical) ? "vertical" : null
        );
      },
      methods: {
        index() {
        ...
        show(t) {
          const e = this.toggles.filter((r) => !E(r, zs)),
            i = this.index(),
            s = ot(!ti(t) || m(e, t) ? t : 0, e, ot(this.toggles[i], e)),
    ...
    pc = {
      ...
      connected() {
        const t = y(this.$el, "uc-tab-left")
          ? "uc-tab-left"
          : y(this.$el, "uc-tab-right")
          ? "uc-tab-right"
          : !1;
        t &&
      ...
      events: [
        {
          ...
          handler(t) {
            (this._preventClick = null),
              !(!yt(t) || se(this._showState) || this.$el.disabled) &&
                (g(this.$el, "focus"),
                H(
                  document,
                  ft,
        ...
        },
        {
          ...
          handler(t) {
            ...
            const e = m(["mouseenter", ue, "focus"], t.type),
  ...
  return (
    Nt(vc, (t, e) => ut.component(e, t)),
    Dl(ut),
    Nt(Ol, (t, e) => ut.component(e, t)),
    ut
  );
});
